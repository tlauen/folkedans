...
window.KJELDE_ORDLISTE = {
  ...
  "DT:F": {
    ...
    tekst: "Egil Bakka og Arne Wikan (1996)",
  ...
  "DT:NT": {
    ...
    tekst: "Egil Bakka, Dag Vårdal og Tormod Lunde (1984)",
  ...
  "DT:VA": {
    ...
    tekst: "Egil Bakka, Dag Vårdal og Brit Seland; Slåttar ved Ånon Egeland  (1990)",
  ...
  "GIF": {
    ...
    tekst: "Egil Bakka, Brit Seland og Dag Vårdal (1991)",
  ...
  "KARI": {
    ...
    tekst: "Berit Eldbjørg Bjerkem (1990)",
  ...
  "PRØYSEN": {
    ...
    tekst: "Ingrid Maurstad Tuko og Nils Steinar Slapgård (2009)",
    url: "",
    nb: "",
    start: ""
  },
